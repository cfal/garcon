...
export const ERROR_CODES = [
  ...
  // Execution-node CLI bridge
  'CLI_CONTROLLER_UNAVAILABLE',
  'CLI_CONTROLLER_CHANGED',
  'CLI_ACCESS_DENIED',
  'CLI_SERVICE_BUSY',
  'CLI_REQUEST_TOO_LARGE',
  'CLI_RESULT_TOO_LARGE',
  'CLI_OUTCOME_UNKNOWN',
  // Queue mutations
  ...
  'TICKET_UNAUTHORIZED',
  'TICKET_FORBIDDEN',
  'TICKET_COMMANDS_DISABLED',
  'TICKET_NOT_FOUND',
  'TICKET_COMMENT_NOT_FOUND',
  'TICKET_CHAT_NOT_FOUND',
  'TICKET_STORE_CHANGED',
  'TICKET_REVISION_CONFLICT',
  'TICKET_COMMENT_REVISION_CONFLICT',
  'TICKET_ALREADY_CLAIMED',
  'TICKET_REQUEST_CONFLICT',
  'TICKET_COLLECTION_CHANGED',
  'TICKET_RELATIONSHIP_CYCLE',
  'TICKET_INVALID_TRANSITION',
  'TICKET_LIMIT_REACHED',
  'TICKET_SOURCE_UNAVAILABLE',
  'TICKET_REQUEST_TOO_LARGE',
  'TICKET_RESULT_TOO_LARGE',
  'TICKET_PROJECT_UNAVAILABLE',
