...
export async function withGitOperation<T>(root: string, options: (ExecutorCallOptions & { mutation?: boolean }) | undefined, operation: (signal: AbortSignal) => Promise<T>): Promise<T> {
