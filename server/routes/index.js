...
export default function createAllRoutes(registry, settings, queue, pathCache, metadata, historyCache, agents, pendingInputs, telegramNotifier, shareStore, apiProviders, chatCommands) {
  return {
    ...staticRoutes,
    ...authRoutes,
