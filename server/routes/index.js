...
export default function createAllRoutes(registry, settings, queue, pathCache, metadata, historyCache, agents, pendingInputs, telegramNotifier, shareStore, apiProviders) {
  return {
    ...staticRoutes,
    ...authRoutes,
    ...createAgentRoutes({ agents, apiProviders }),
    ...createApiProviderRoutes(apiProviders),
    ...createChatRoutes(registry, settings, queue, pathCache, metadata, historyCache, agents, pendingInputs),
    ...createShareRoutes(shareStore, registry, settings, metadata, historyCache),
    ...createFilesRoutes(registry),
    ...createWorkspaceRoutes(settings, agents, telegramNotifier),
