...
import { createStatusOperations, resolveNetworkGitTimeoutMs } from "../status.js";
...
describe("network git options wiring", () => {
  ...
  beforeAll(() => {
    ...
    operations = createStatusOperations({ networkTimeoutMs: resolveNetworkGitTimeoutMs(4) });
  });
