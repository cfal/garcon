...
it('rejects a file PUT when the chat moves to a remote executor while its body is read', async () => {
  const chat = { projectPath, executorId: undefined };
  ...
  request.text = async () => {
    chat.executorId = '22222222-2222-4222-8222-222222222222';
    return readBody();
  };
