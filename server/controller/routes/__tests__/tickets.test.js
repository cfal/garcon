...
import { TICKET_ERROR_POLICY, TicketDomainError } from '../../../common/ticket-error.js';
...
describe('authenticated Tickets routes', () => {
  ...
  test('keeps invalid executor selectors inside the ticket error contract', async () => {
    const result = await call('/project-default', { directory: '/project', executorId: 'invalid' });
