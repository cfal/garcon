...
describe('delegated start selection', () => {
  ...
  test('inherits a remote parent executor unless the command explicitly selects another executor', () => {
    const f = fixture();
    f.parent.executorId = '22222222-2222-4222-8222-222222222222';
    expect(f.resolve().executorId).toBe(f.parent.executorId);
    expect(f.resolve({ executorId: 'local' }).executorId).toBe('local');
    expect(f.resolve({ executorId: '33333333-3333-4333-8333-333333333333' }).executorId)
