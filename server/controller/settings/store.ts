...
export class SettingsStore extends EventEmitter<SettingsStoreEvents> {
  ...
  constructor(
    ...
    this.#retainExecutorReferences = deps.retainExecutorReferences;
  ...
  forgetExecutor(executorId: string): Promise<void> {
    return this.#startupDefaults.forgetExecutor(executorId);
  }
