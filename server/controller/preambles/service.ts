...
export class PreambleService extends EventEmitter<PreambleServiceEvents> {
  ...
  resolve(canonicalProjectPath: string, executorId?: string | null): readonly Preamble[] {
    return applicablePreambles(this.snapshot().preambles, canonicalProjectPath, executorId);
  }
