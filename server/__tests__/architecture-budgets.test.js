...
// Turn receipts add a separately reviewed 358-line ledger, projection, result
// budget, terminal-race handling, and atomic resume-admission increment for the
// consultation CLI.
const EXECUTION_FOOTPRINT_BUDGET = 7723;
