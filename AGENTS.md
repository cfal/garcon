...
- cursor, pi, and opencode are best-effort providers: unit coverage only, no scripted-model tier. Do not assume scripted or live parity when changing them; Claude and Codex are the reference integrations.
