...
- **Organize chats visually.** Choose Open canvas from the window menu to arrange live chat cards into named boxes, connect related work, and save multiple boards. Switch to the grouped list for touch and keyboard editing.
