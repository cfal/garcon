...
import { createSidebarProjectCollapseStore } from '../sidebar-project-collapse.svelte';
...
describe('SidebarProjectCollapseStore', () => {
	...
	it('persists collapsed project keys', () => {
		...
		expect(JSON.parse(localStorage.getItem(LOCAL_STORAGE_KEYS.sidebarProjectCollapse) ?? '{}')).toEqual({
