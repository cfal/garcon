...
import {
	installCompletionSoundUnlockListeners,
...
describe('completion sound', () => {
	...
	it('does not initialize Web Audio until completion sounds are enabled', () => {
		...
		let enabled = false;
		const removeListeners = installCompletionSoundUnlockListeners(() => enabled);
