				...
				<div class="space-y-4 min-w-0">
					...
					<div class="space-y-1">
						...
						<Textarea
							...
							class="chat-mobile-compact-textarea w-full max-w-full min-w-0 resize-none min-h-16 font-mono text-base sm:text-xs"
						/>
					</div>
					<div class="space-y-1">
						<div class="flex items-center justify-between gap-2">
					...
					<div class="space-y-1">
						...
						<Textarea
							...
							class="chat-mobile-compact-textarea w-full max-w-full min-w-0 h-40 max-h-[40vh] resize-none overflow-y-auto font-mono text-base sm:text-xs"
						/>
					</div>
				</div>
			</div>
