...
describe('formatSidebarChatTimestamp', () => {
	it('uses compact relative hour labels', () => {
		expect(
			formatSidebarChatTimestamp('2026-04-19T05:00:00.000Z', new Date('2026-04-19T08:30:00.000Z')),
		).toEqual({
			label: '3h ago',
	...
	it('uses compact relative minute labels', () => {
		expect(
			formatSidebarChatTimestamp('2026-04-19T08:18:00.000Z', new Date('2026-04-19T08:30:00.000Z')),
		).toEqual({
			label: '12m ago',
	...
	it('uses now for timestamps less than one minute old', () => {
		expect(
			formatSidebarChatTimestamp('2026-04-19T08:29:30.000Z', new Date('2026-04-19T08:30:00.000Z')),
		).toEqual({
			label: 'now',
	...
	it('uses compact relative day labels', () => {
		expect(
			formatSidebarChatTimestamp('2026-04-17T08:30:00.000Z', new Date('2026-04-19T08:30:00.000Z')),
		).toEqual({
			label: '2d ago',
	...
	it('uses compact relative month labels for older chats', () => {
		expect(
			formatSidebarChatTimestamp('2026-02-18T08:30:00.000Z', new Date('2026-04-19T08:30:00.000Z')),
		).toEqual({
			label: '2mo ago',
	...
	it('uses compact relative year labels for old chats', () => {
		expect(
			formatSidebarChatTimestamp('2025-04-19T08:30:00.000Z', new Date('2026-04-19T08:30:00.000Z')),
		).toEqual({
			label: '1y ago',
	...
	it('preserves future direction when clock skew is large enough to matter', () => {
		expect(
			formatSidebarChatTimestamp('2026-04-19T08:35:00.000Z', new Date('2026-04-19T08:30:00.000Z')),
		).toEqual({
			label: 'in 5m',
