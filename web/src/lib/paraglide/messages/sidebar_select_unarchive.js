...
/** @typedef {{}} Sidebar_Select_UnarchiveInputs */

const en_sidebar_select_unarchive = /** @type {(inputs: Sidebar_Select_UnarchiveInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Unarchive`)
};
...
* | "Unarchive" |
*
* @param {Sidebar_Select_UnarchiveInputs} inputs
